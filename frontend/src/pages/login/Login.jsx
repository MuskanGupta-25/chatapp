            ...
            <div className='w-full p-6 rounded-lg shadow-md bg-orange-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input type='text' placeholder='Enter username' className='w-full bg-stone-500 input input-bordered h-10' value={username}
                    ...
                    <div>
                        ...
                        <input type='password' placeholder='Enter password' className='w-full bg-stone-500 input input-bordered h-10 ' value={password}
                        onChange={(e)=>setPassword(e.target.value)}></input>
                    </div>

                    <Link to='/signup' className='text-sm text-white hover:underline hover:text-stone-500 mt-2 inline-block'>
                        {"Don't"} have an account?
                    </Link>

                <div>
                   <button className='btn btn-block btn-sm mt-2 bg-stone-500 hover:bg-stone-600 text-stone-300' disabled={loading}>{loading? <span className='loading loading-spinner'></span>:"Login"} </button> 
                </div>
                </form>
            </div>
